...
public class TriangulateTest {
	...
	/* Reads in csv files and performs voronoi partitioning. 
	 * 
	 * test files can be generated using the script:
	 *		results/generate_random_clusters.csv
	 *
	 * input file should be named dataset###.csv
	 * 
	 * The output is a file containing:
	 ...
	 * 
	 * These results can be visualized using scripts: 
	 * */
