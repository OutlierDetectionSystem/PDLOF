...
//	public static final String strKNNJoinOutputMerge = "lof.knn.join.output.merge";
//	public static final String strKNNJoinOutputMergeToOne = "lof.knn.join.output.merge.toOne";
